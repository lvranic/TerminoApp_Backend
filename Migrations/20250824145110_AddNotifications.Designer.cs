...
namespace TerminoApp_NewBackend.Migrations
{
    ...
    [Migration("20250824145110_AddNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TerminoApp_NewBackend.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("TerminoApp_NewBackend.Models.User", b =>
                {
                    ...
                    b.Property<List<string>>("WorkDays")
                        .HasColumnType("text[]");

                    b.Property<string>("WorkHours")
                        .HasColumnType("text");

                    b.Property<string>("WorkingHoursRange")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TerminoApp_NewBackend.Models.Reservation", b =>
                {
                    b.HasOne("TerminoApp_NewBackend.Models.User", "Provider")
                        .WithMany("ReceivedReservations")
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TerminoApp_NewBackend.Models.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("TerminoApp_NewBackend.Models.User", b =>
                {
                    ...
                    b.Navigation("ReceivedReservations");
